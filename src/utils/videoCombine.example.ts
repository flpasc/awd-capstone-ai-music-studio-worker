...
// createVideoFromImageAndAudio('assets/image1.png', 'assets/audio1.mp3', 'video5.mp4', { signal: abortController1.signal, imageTime: 10 });
...
}, 'slideshow.mp4', { signal: abortController2.signal, pixelFormat: 'yuv422p' });
